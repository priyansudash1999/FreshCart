    ...
    <div className='mt-20 '>
              ...
              return (
                <div>
                  <div className='grid grid-cols-[1.25fr_1.5fr_1fr_1fr_1fr_0.5fr] cart-items-item items-center text-black'>
                    <img src={url + "/images/" + food.image} alt="" className='w-[50px]'/>
                    <p>{food.name}</p>
                    <p>${food.price}</p>
      ...
      <div className='mt-16 flex justify-between gap-4 max-[750px]:flex-col-reverse'>
        <div className="flex flex-1 flex-col gap-4">
          ...
          <button onClick={() => navigate("/order")} className='border-none text-white bg-orange-600 w-[200px] px-3 py-2 mb-10 rounded'>Proceed to Checkout</button>
        </div>
